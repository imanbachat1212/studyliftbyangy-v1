        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="font-body text-sm text-cream/60 leading-relaxed max-w-xs">
              Expert academic support for SPSS, research, dissertation, APA formatting and more.
            </p>
            <p className="font-display text-gold italic mt-4 text-sm">
              "Study. Lift. Achieve."
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={to}>
                  <Link
                    to={to}
                    className="font-body text-sm text-cream/60 hover:text-gold transition-colors duration-200 cursor-pointer"
                  >
                    {label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 font-body text-sm text-cream/60 hover:text-gold transition-colors duration-200 cursor-pointer"
                >
              ...
              <li className="flex items-center gap-2 font-body text-sm text-cream/60">
                ...
                Dubai, UAE | Online Worldwide
              </li>
              <li className="flex items-center gap-2 font-body text-sm text-cream/60">
                <Clock className="w-4 h-4 text-gold flex-shrink-0" />
                Available Daily | Online Services
              </li>
            </ul>
          </div>
        </div>
